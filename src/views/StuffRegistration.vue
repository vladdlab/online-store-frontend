<template>
  <div class="reg__page">
    <div class="reg__module">
      <h2 class="reg__header">Регистрация Cотрудника</h2>
      <form class="reg__form" @submit.prevent="handleSubmit">
        ...
        <input
          ...
          v-model="rec_book"
          required
          placeholder="Номер трудовой книжки"
        />
        <input
          id="reg_passport"
          type="text"
  ...
  methods: {
    ...
    handleSubmit() {
      this.regStuff({
        ...
        patrony: this.patrony,
        role: this.role,
        rec_book: this.rec_book,
...
.reg {
  &__page {
    ...
    background-image: url('../assets/stuff_reg_background.jpg');
  ...
  &__form {
    ...
    margin: 1em 0;
    border-radius: 15px;
    box-shadow: 0px 0px 100px 0px rgba(44, 62, 80, 0.1);
